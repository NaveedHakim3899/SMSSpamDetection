...
public class MessageouterAdapterSpam extends BaseAdapter {

    List<User> outermessages = new ArrayList<User>();
    Context context;

    public MessageouterAdapterSpam (Context context) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        User user = outermessages.get(i);
            ...
            holder.number = (TextView) convertView.findViewById(R.id.textlayout);
